/// # Flutter TypeAheadGroup
/// A TypeAheadGroup widget for Flutter, where you can show suggestions to
/// users as they type
///
/// ## Features
...
/// )
/// ```
/// In the code above, the `textFieldGroupConfiguration` property allows us to
...
/// )
/// ```
/// Here, we assign to the `controller` property of the `textFieldGroupConfiguration`
...
/// You can customize the text field using the `textFieldGroupConfiguration` property.
/// You provide this property with an instance of `TextFieldGroupConfiguration`,
...
/// TypeAheadGroup provides default configurations for the suggestions box. You can,
...
class TypeAheadGroupFormField<T> extends FormField<String> {
  ...
  final TextFieldGroupConfiguration textFieldGroupConfiguration;
  ...
  TypeAheadGroupFormField(
      ...
      this.textFieldGroupConfiguration = const TextFieldGroupConfiguration(),
      ...
      : assert(initialValue == null || textFieldGroupConfiguration.controller == null),
        assert(minCharsForSuggestions >= 0),
        super(
            key: key,
            onSaved: onSaved,
            validator: validator,
            initialValue: textFieldGroupConfiguration.controller != null
                ? textFieldGroupConfiguration.controller!.text
                : (initialValue ?? ''),
            enabled: enabled,
            autovalidateMode: autovalidateMode,
            builder: (FormFieldState<String> field) {
              final _TypeAheadGroupFormFieldState state =
                  field as _TypeAheadGroupFormFieldState<dynamic>;
              ...
              return TypeAheadGroupField(
                ...
                suggestionsGroupBoxDecoration: suggestionsGroupBoxDecoration,
                suggestionsGroupBoxController: suggestionsGroupBoxController,
                textFieldGroupConfiguration: textFieldGroupConfiguration.copyWith(
                  decoration:
                      textFieldGroupConfiguration.decoration.copyWith(errorText: state.errorText),
                  onChanged: (text) {
                    state.didChange(text);
                    textFieldGroupConfiguration.onChanged?.call(text);
                  },
...
class _TypeAheadGroupFormFieldState<T> extends FormFieldState<String> {
  ...
  TextEditingController? get _effectiveController =>
      widget.textFieldGroupConfiguration.controller ?? _controller;
  ...
  void initState() {
    super.initState();
    if (widget.textFieldGroupConfiguration.controller == null) {
      _controller = TextEditingController(text: widget.initialValue);
    } else {
      widget.textFieldGroupConfiguration.controller!.addListener(_handleControllerChanged);
    }
  }
  ...
  void didUpdateWidget(TypeAheadGroupFormField oldWidget) {
    ...
    if (widget.textFieldGroupConfiguration.controller !=
        oldWidget.textFieldGroupConfiguration.controller) {
      oldWidget.textFieldGroupConfiguration.controller?.removeListener(_handleControllerChanged);
      widget.textFieldGroupConfiguration.controller?.addListener(_handleControllerChanged);

      if (oldWidget.textFieldGroupConfiguration.controller != null &&
          widget.textFieldGroupConfiguration.controller == null)
        _controller = TextEditingController.fromValue(
            oldWidget.textFieldGroupConfiguration.controller!.value);
      if (widget.textFieldGroupConfiguration.controller != null) {
        setValue(widget.textFieldGroupConfiguration.controller!.text);
        if (oldWidget.textFieldGroupConfiguration.controller == null) _controller = null;
      }
    }
  }
  ...
  @override
  void dispose() {
    widget.textFieldGroupConfiguration.controller?.removeListener(_handleControllerChanged);
    super.dispose();
  }
...
class TypeAheadGroupField<T> extends StatefulWidget {
  ...
  /// Called to display animations when [suggestionsGroupCallback] returns suggestions
  ///
  ...
  /// property in the [textFieldGroupConfiguration] to true
  ///
  /// Defaults to false
...
class _TypeAheadGroupFieldState<T> extends State<TypeAheadGroupField<T>>
  ...
  TextEditingController? get _effectiveController =>
      widget.textFieldGroupConfiguration.controller ?? _textEditingController;

  FocusNode? get _effectiveFocusNode => widget.textFieldGroupConfiguration.focusNode ?? _focusNode;
  ...
  void initState() {
    ...
    final textFieldGroupConfigurationFocusNode = widget.textFieldGroupConfiguration.focusNode;
    if (textFieldGroupConfigurationFocusNode == null) {
      this._focusNode = FocusNode(onKey: _onKeyEvent);
    } else if (textFieldGroupConfigurationFocusNode.onKey == null) {
      // * we add the _onKeyEvent callback to the textFieldGroupConfiguration focusNode
      textFieldGroupConfigurationFocusNode.onKey = ((node, event) {
        final keyEventResult = _onKeyEvent(node, event);
        return keyEventResult;
      });
    } else {
      final onKeyCopy = textFieldGroupConfigurationFocusNode.onKey!;
      textFieldGroupConfigurationFocusNode.onKey = ((node, event) {
    ...
    widget.suggestionsGroupBoxController?._suggestionsBox = this._suggestionsBox;
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: TextField(
        ...
        controller: this._effectiveController,
        decoration: widget.textFieldGroupConfiguration.decoration,
        style: widget.textFieldGroupConfiguration.style,
        textAlign: widget.textFieldGroupConfiguration.textAlign,
        enabled: widget.textFieldGroupConfiguration.enabled,
        keyboardType: widget.textFieldGroupConfiguration.keyboardType,
        autofocus: widget.textFieldGroupConfiguration.autofocus,
        inputFormatters: widget.textFieldGroupConfiguration.inputFormatters,
        autocorrect: widget.textFieldGroupConfiguration.autocorrect,
        maxLines: widget.textFieldGroupConfiguration.maxLines,
        textAlignVertical: widget.textFieldGroupConfiguration.textAlignVertical,
        minLines: widget.textFieldGroupConfiguration.minLines,
        maxLength: widget.textFieldGroupConfiguration.maxLength,
        maxLengthEnforcement: widget.textFieldGroupConfiguration.maxLengthEnforcement,
        obscureText: widget.textFieldGroupConfiguration.obscureText,
        onChanged: widget.textFieldGroupConfiguration.onChanged,
        onSubmitted: widget.textFieldGroupConfiguration.onSubmitted,
        onEditingComplete: widget.textFieldGroupConfiguration.onEditingComplete,
        onTap: widget.textFieldGroupConfiguration.onTap,
//         onTapOutside: (_) {},
        scrollPadding: widget.textFieldGroupConfiguration.scrollPadding,
        textInputAction: widget.textFieldGroupConfiguration.textInputAction,
        textCapitalization: widget.textFieldGroupConfiguration.textCapitalization,
        keyboardAppearance: widget.textFieldGroupConfiguration.keyboardAppearance,
        cursorWidth: widget.textFieldGroupConfiguration.cursorWidth,
        cursorRadius: widget.textFieldGroupConfiguration.cursorRadius,
        cursorColor: widget.textFieldGroupConfiguration.cursorColor,
        textDirection: widget.textFieldGroupConfiguration.textDirection,
        enableInteractiveSelection: widget.textFieldGroupConfiguration.enableInteractiveSelection,
...
class _SuggestionsGroupListState<T> extends State<_SuggestionsGroupList<T>>
  ...
  Iterable<TypeAheadDataGroup<T>>? _groupSuggestions;
  ...
  void initState() {
    ...
    widget.keyboardSuggestionSelectionNotifier.addListener(() {
      // final suggestionsLength = _groupSuggestions?.length;
  ...
  Future<void> _getSuggestions() async {
    ...
    if (mounted) {
      ...
      Iterable<TypeAheadDataGroup<T>>? suggestions;
      Object? error;

      try {
        suggestions = await widget.suggestionsGroupCallback!(widget.controller!.text);
      } catch (e) {
        error = e;
      }
      ...
      if (this.mounted) {
        ...
        setState(() {
          ...
          this._error = error;
          this._isLoading = false;
          this._groupSuggestions = suggestions;
          // _focusNodes = List.generate(
          //   _groupSuggestions?.length ?? 0,
  ...
  @override
  Widget build(BuildContext context) {
    bool isEmpty = this._groupSuggestions?.length == 0 && widget.controller!.text == "";
    if ((this._groupSuggestions == null || isEmpty) &&
        this._isLoading == false &&
    ...
    } else if (this._groupSuggestions!.isEmpty) {
  ...
  Widget createLoadingWidget() {
    ...
    if (widget.keepSuggestionsOnLoading! && this._groupSuggestions != null) {
      if (this._groupSuggestions!.isEmpty) {
        child = createNoItemsFoundWidget();
      } else {
        child = createSuggestionsWidget();
      }
  ...
  Widget createSuggestionsWidget() {
    Widget child = CustomScrollView(
      ...
      slivers: List.generate(this._groupSuggestions!.length, (index) {
        final groupSuggestions = _groupSuggestions!.elementAt(index);
        return SliverStickyHeader(
          header: widget.titleGroupBuilder!(context, groupSuggestions.title),
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, i) {
                // final focusNode = _focusNodes[i];
                final T item = groupSuggestions.items[i];
              ...
              childCount: groupSuggestions.items.length,
            ),
          ),
        );
      }),
...
/// Supply an instance of this class to the [TypeAheadGroup.textFieldGroupConfiguration]
/// property to configure the displayed text field
class TextFieldGroupConfiguration {
  ...
  /// Creates a TextFieldGroupConfiguration
  const TextFieldGroupConfiguration({
  ...
  /// Copies the [TextFieldGroupConfiguration] and only changes the specified
  /// properties
  TextFieldGroupConfiguration copyWith(
    ...
    return TextFieldGroupConfiguration(
